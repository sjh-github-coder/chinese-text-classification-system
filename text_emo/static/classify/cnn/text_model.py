...
class TextConfig():
    ...
    vocab_size=15000        #number of vocabulary
    ...
    train_filename='D:/python/PycharmProjects/Emo_classify/text_emo/static/classify/cnn/data/cnews.train.txt'  #train data
    test_filename='D:/python/PycharmProjects/Emo_classify/text_emo/static/classify/cnn/data/cnews.test.txt'    #test data
    val_filename='D:/python/PycharmProjects/Emo_classify/text_emo/static/classify/cnn/data/cnews.val.txt'      #validation data
    vocab_filename='D:/python/PycharmProjects/Emo_classify/text_emo/static/classify/cnn/data/vocab.txt'        #vocabulary
    #vector_word_filename='./data/vector_word.txt'  #vector_word trained by word2vec
    vector_word_npz='D:/python/PycharmProjects/Emo_classify/text_emo/static/classify/cnn/data/vector_word.npz'   # save vector_word to numpy file
    #wiki_filename='./data/wiki.txt'
    model_filename='D:/python/PycharmProjects/Emo_classify/text_emo/static/classify/cnn/model/word2vec.model'
...
class TextCNN(object):
    ...
    def __init__(self,config):
        ...
        self.input_x=tf.placeholder(tf.int64,shape=[None,self.config.seq_length],name='input_x')
